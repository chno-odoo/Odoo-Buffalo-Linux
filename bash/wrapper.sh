...
GUI_SCRIPT_URL="https://raw.githubusercontent.com/chno-odoo/Odoo-Buffalo-Linux/2.0-development/bash/gui_settings.sh"
BACKEND_SETTINGS_URL="https://raw.githubusercontent.com/chno-odoo/Odoo-Buffalo-Linux/2.0-development/bash/backend_settings.sh"
