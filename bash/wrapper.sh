...
GUI_SCRIPT_URL="https://raw.githubusercontent.com/chno-odoo/Odoo-Buffalo-Linux/5.0/bash/gui_settings.sh"
BACKEND_SETTINGS_URL="https://raw.githubusercontent.com/chno-odoo/Odoo-Buffalo-Linux/5.0/bash/backend_settings.sh"
